    ...
    public partial class IngredientServiceTests
    {
            ...
            , string[] expectedMessages)
        {
            ...
            _ingredientRepositoryMock
                .Setup(x => x.UpdateAsync(It.IsAny<IngredientDto>(), It.IsAny<string>()))
                .ReturnsAsync(ingredientDto);

            // Act
            var actualApiResult = await _ingredientService.UpdateAsync(ingredientDto, null).ConfigureAwait(false);
